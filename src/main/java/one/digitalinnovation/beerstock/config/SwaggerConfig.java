...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Romário Pereira Marinho";
    private static final String CONTACT_GITHUB = "https://gtihub.com/EngRomario";
    private static final String CONTACT_EMAIL = "eng.romario.ufg@gmail.com";
